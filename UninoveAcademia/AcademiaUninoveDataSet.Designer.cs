...
namespace UninoveAcademia.AcademiaUninoveDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Login] WHERE (([Codigo] = @Original_Codigo) AND ([Usuario] = @" +
                "Original_Usuario) AND ([Senha] = @Original_Senha) AND ([Tipo_Usuario] = @Origina" +
                "l_Tipo_Usuario) AND ([Data_Criacao] = @Original_Data_Criacao))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [Codigo] = @Codigo, [Usuario] = @Usuario, [Senha] = @Senha, [Tipo_Usuario] = @Tipo_Usuario, [Data_Criacao] = @Data_Criacao WHERE (([Codigo] = @Original_Codigo) AND ([Usuario] = @Original_Usuario) AND ([Senha] = @Original_Senha) AND ([Tipo_Usuario] = @Original_Tipo_Usuario) AND ([Data_Criacao] = @Original_Data_Criacao));
SELECT Codigo, Usuario, Senha, Tipo_Usuario, Data_Criacao FROM Login WHERE (Codigo = @Codigo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\AcademiaUnino" +
                "ve.mdf;Integrated Security=True;Connect Timeout=30";
        }
        ...
        public virtual int Delete(int Original_Codigo, string Original_Usuario, string Original_Senha, string Original_Tipo_Usuario, System.DateTime Original_Data_Criacao) {
        ...
        public virtual int Insert(int Codigo, string Usuario, string Senha, string Tipo_Usuario, System.DateTime Data_Criacao) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((System.DateTime)(Data_Criacao));
        ...
        public virtual int Update(int Codigo, string Usuario, string Senha, string Tipo_Usuario, System.DateTime Data_Criacao, int Original_Codigo, string Original_Usuario, string Original_Senha, string Original_Tipo_Usuario, System.DateTime Original_Data_Criacao) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(Data_Criacao));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.DateTime)(Original_Data_Criacao));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Usuario, string Senha, string Tipo_Usuario, System.DateTime Data_Criacao, int Original_Codigo, string Original_Usuario, string Original_Senha, string Original_Tipo_Usuario, System.DateTime Original_Data_Criacao) {
